...
description: "Teach your AI receptionist everything about your business — services, pricing, hours, FAQs, and more. [Manage your Knowledge Base](https://app.closethecall.com/knowledge) in the dashboard."
icon: "book-open"
---
...
flowchart TD
    subgraph Sources["5 Data Sources"]
        S1["Website Scrape"]
        S2["Google Business Profile"]
        S3["Manual Entry"]
        S4["Document Upload<br/>(PDF, TXT, CSV)"]
        S5["AI Call Learning"]
    end

    subgraph Categories["12 Knowledge Categories"]
        C1["Services (20%)"]
        C2["Pricing (15%)"]
        C3["Hours (15%)"]
        C4["Booking (10%)"]
        C5["Location / FAQ / Policies<br/>Team / Promotions / Payments<br/>Emergency / Custom (40%)"]
    end

    subgraph Output["AI Output"]
        IS["Intelligence Score<br/>(0-100)"]
        SP["System Prompt<br/>(built from articles)"]
        AI["AI Receptionist<br/>answers calls"]
    end
...
<Steps>
  <Step title="Go to Knowledge Base">
    Click **Knowledge Base** in the left sidebar of your [dashboard](https://app.closethecall.com/knowledge).
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="What if two sources conflict?">
    **Manual edits always win.** If you hand-type a price of $150 and your website says $120, the AI uses $150. For non-manual conflicts (e.g., website says one thing, Google Business Profile says another), the most recently updated source takes priority. You can always verify the correct article and delete the incorrect one.
  </Accordion>
  <Accordion title="Can I export my Knowledge Base?">
  ...
  <Accordion title="Does the AI use all articles on every call?">

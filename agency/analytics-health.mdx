...
- **Revenue** — total client deposits over the selected period
...
A bar chart showing monthly revenue over the past 6 months. Revenue is calculated from client wallet deposits (before the 5% platform fee is deducted).
...
| **Wallet Balance** | 15% | Current balance relative to weekly usage (how many days of calls can they afford) |
...
<CardGroup cols={4}>
  ...
  <Card title="At Risk" icon="face-meh">
    **40–59**
    ...
    Declining. Check wallet, call volume, or KB gaps.
  </Card>
  <Card title="Critical" icon="face-frown">
    **0–39**

    Immediate attention. May be inactive or out of funds.
  </Card>
</CardGroup>
...
|-------|-------------------|-----------------|
| **Low Wallet** | Balance below $10 | Client's wallet balance drops below your threshold |
...
- **Threshold** — the value that triggers the alert (e.g., $10 for low wallet, 7 days for inactive)

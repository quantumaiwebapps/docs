...
|-------|------------|---------|
| **Thriving** | 80–100 | Client is active, converting leads, wallet funded |
| **Healthy** | 60–79 | Performing well, minor areas for improvement |
| **At Risk** | 40–59 | Declining activity or low wallet — needs attention |
| **Critical** | 0–39 | Inactive or out of funds — immediate action needed |

Health scores are calculated from 6 factors: call volume, lead conversion, knowledge base quality, wallet balance, response rate, and recent activity. See [Analytics & Health Scores](/agency/analytics-health) for the full breakdown.
...
2. Billing begins (minutes are deducted from their wallet)

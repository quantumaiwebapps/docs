...
<Note>
**Go to your account settings:** [Open Account Settings](https://app.closethecall.com/account)
</Note>
...
```mermaid
flowchart LR
    A[Enable 2FA] --> B[Scan QR Code]
    B --> C[Enter 6-digit Code]
    C --> D{Code Valid?}
    D -->|Yes| E[Save Backup Codes]
    D -->|No| C
    E --> F[2FA Active]
```
